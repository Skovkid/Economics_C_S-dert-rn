...
result_df <- result_df %>% 
  select(-iso3c.y.y.y,-country.y.y.y,-iso3c.x.x.x,-country.x.x.x,-iso3c.y.y,-country.y.y,-iso3c.x.x,-country.x.x,-iso3c.y,-country.y,-iso3c.x,country.x, -country.x)
